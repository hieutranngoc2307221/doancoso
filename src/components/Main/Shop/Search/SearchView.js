            ...
            <ScrollView style={wrapper}>
                <View style={product}>
                    ...
                    <View style={mainRight}>
                        <Text style={txtName}>{toTitleCase('Váy chấm bi')}</Text>
                        <Text style={txtPrice}>200.000</Text>
                        <Text style={txtMaterial}>Trang phụ đi dự tiệc</Text>
                        <View style={{ flexDirection: 'row' }} >
                            <Text style={txtColor}>Màu trắng</Text>
                            <View
                                style={{
                                    height: 15,
                                    width: 15,
